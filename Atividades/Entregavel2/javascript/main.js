...
/* ALGORITMO 5 - ORDENAR */
function ordenar(){
let numero1 = parseInt(document.getElementById("q5-i1").value);
let numero2 = parseInt(document.getElementById("q5-i2").value);
let numero3 = parseInt(document.getElementById("q5-i3").value);
let numero4 = parseInt(document.getElementById("q5-i4").value);
